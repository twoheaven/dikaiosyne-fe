...
준용합니다.」
제2조(정의)
① "몰"이란 럽앤굿모먼트가 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기
...
신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 dikaiosyne의 초기
...
계약에 의해 제공할 재화 또는 용역의 내용을 변경할 수 있습니다. 이 경우에는 변경된 재화
또는 용역의 내용 및 제공일자를 명시하여 현재의 재화 또는 용역의 내용을 게시한 곳에 즉시
공지합니다.
...
날부터 10일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를
취합니다. 다만, "몰"이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부
또는 일부를 받은 날부터 3영업일 이내에 조치를 취합니다.이때 "몰"은 이용자가 재화 등의
...
청약철회 등이 제한되지 않습니다.
④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화 등의 내용이 표시ﾷ광고 내용과 다르거나
...
② "몰"은 위 대금을 환급함에 있어서 이용자가 신용카드 또는 전자화폐 등의 결제수단으로
...
내용이 표시ﾷ광고 내용과 다르거나 계약내용과 다르게 이행되어 청약철회 등을 하는 경우 재화
등의 반환에 필요한 비용은 "몰"이 부담합니다.
④ 이용자가 재화 등을 제공받을 때 발송비를 부담한 경우에 "몰"은 청약철회 시 그 비용을누가
부담하는지를 이용자가 알기 쉽도록 명확하게 표시합니다.
제17조(개인정보보호)
① "몰"은 이용자의 개인정보 수집시 서비스제공을 위하여 필요한 범위에서 최소한의
개인정보를 수집합니다.
② "몰"은 회원가입시 구매계약이행에 필요한 정보를 미리 수집하지 않습니다. 다만, 관련
법령상 의무이행을 위하여 구매계약 이전에 본인확인이 필요한 경우로서 최소한의 특정
개인정보를 수집하는 경우에는 그러하지 아니합니다.
③ "몰"은 이용자의 개인정보를 수집ﾷ이용하는 때에는 당해 이용자에게 그 목적을 고지하고
동의를 받습니다.
④ "몰"은 수집된 개인정보를 목적외의 용도로 이용할 수 없으며, 새로운 이용목적이 발생한
경우 또는 제3자에게 제공하는 경우에는 이용ﾷ제공단계에서 당해 이용자에게 그 목적을
...
정정을 요구한 경우에는 "몰"은 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다.
...
⑧ "몰" 또는 그로부터 개인정보를 제공받은 제3자는 개인정보의 수집목적 또는 제공받은
목적을 달성한 때에는 당해 개인정보를 지체 없이 파기합니다.
⑨ "몰"은 개인정보의 수집ﾷ이용ﾷ제공에 관한 동의 란을 미리 선택한 것으로 설정해두지
않습니다. 또한 개인정보의 수집ﾷ이용ﾷ제공에 관한 이용자의 동의거절시 제한되는 서비스를
구체적으로 명시하고, 필수수집항목이 아닌 개인정보의 수집ﾷ이용ﾷ제공에 관한 이용자의 동의
거절을 이유로 회원가입 등 서비스 제공을 제한하거나 거절하지 않습니다.
제18조("몰"의 의무)
① "몰"은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이
...
대한 저작권 및 지적 재산권은 해당 이용자에게 있으며, 이용자는 "몰"에 해당 이용자 콘텐츠를
무상으로 이용할 수 있는 권리를 부여합니다. 이용자가 공개적으로 작성 및 공유한 콘텐츠(예:
상품 리뷰)의 경우 "몰"은 제품의 홍보를 위해 상점 내에 이용자의 콘텐츠를 재가공하여
영구적으로 인용할 수 있습니다.
제23조(분쟁해결)
...
경우에는 공정거래위원회 또는 시ﾷ도지사가 의뢰하는 분쟁조정기관의 조정에 따를 수 있습니다.
제24조(적립금 제도)
① "몰"은 "몰"의 정책에 따라 적립금, 쿠폰(이하 '적립금 등'이라 함)제도를 운영합니다.
② "몰"은 재화 등의 구매, 이벤트 등 정책에 따라 회원에게 적립금 또는 쿠폰을 지급할 수
있습니다.
③ "몰"은 구입한 재화 등의 주문취소, 반품의 경우 혹은 회원의 요청 등에 따라 환불 대금을
적립금으로 지급할 수 있습니다.
④ 회원은 재화 등을 구매 시 단독으로 또는 다른 결제수단과 결합하여 '적립금 등'을 현금과
동일하게 사용할 수 있으나, "몰"이 사전에 사용이 불가능하다고 고지한 경우에는 이를 사용할
수 없습니다.
⑤ 다음 각 호의 경우 '적립금 등'은 소멸됩니다.
1. "몰"을 탈퇴한 경우
2. "몰"의 정책에 따라 적립금 및 쿠폰의 사용가능 조건 및 소멸에 대한 기준이 도래한 경우
⑥ 회원은 '적립금 등'을 타인에게 매매 또는 양도할 수 없고, 이를 부정하게 취득한 경우
"몰"의 권한으로 '적립금 등'을 회수할 수 있습니다.
제25조(재판권 및 준거법)
...
부 칙(시행일) 이 약관은 2024년 12월 24일부터 시행합니다.`
  );
